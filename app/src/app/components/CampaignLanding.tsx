...
export default function CampaignLanding({
  ...
  return (
    <div className="grid sm:grid-cols-2 h-screen w-screen font-sans overflow-hidden">
      <div className="shadow-2xl h-full bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-stone-300 via-indigo-300 to-emerald-400 sm:bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] sm:from-[#101010] sm:via-[#121212] sm:to-black">
        <div className="w-full h-full p-6 text-slate-800 sm:text-slate-200">
          <div className="flex flex-col items-center justify-between h-full">
            <div className="flex flex-row justify-between items-center w-full">
              ...
              <a className="cursor-pointer uppercase font-sans font-black text-sm" href={`https://x.com/${artist.twitterUsername}`} target="_blank">@{artist.twitterUsername}</a>
            </div>
            <div className="w-full flex flex-col gap-6 items-center justify-center h-full">
              <div className="flex flex-col text-3xl pb-3 items-center justify-center">
                <div className="font-sans font-black uppercase">
                {artist.nickname}
                </div>
                <div className="font-title italic">
                  Autograph Session
                </div>
              </div>
